...
export const LONG_PAUSE = '<break strength="x-strong"/>';
export const PAUSE_BETWEEN_ITEMS = `${LONG_PAUSE}<audio src="soundbank://soundlibrary/computers/beeps_tones/beeps_tones_08"/>${LONG_PAUSE}`;
